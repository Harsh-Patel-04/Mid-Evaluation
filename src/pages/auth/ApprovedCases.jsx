...
//         setCases(casesWithMedia);
//       } catch (err) {
//         setError(err.message || "Failed to fetch resolved cases");
...
//         {
//           user_id: user.id,
//           message: `Case ${caseId} has been resolved.`,
//           status: "new",
...
//       <AuthNavbar />
//       <main className="flex-grow p-8 max-w-7xl mx-auto w-full">
//         <h1 className="text-4xl font-bold text-gray-800 mb-8">Resolved Cases</h1>
//         {cases.length === 0 ? (
//           <div className="bg-blue-100 border border-blue-400 text-blue-700 px-4 py-3 rounded relative">
...
//                         </h3>
//                         <p className="text-gray-700 font-medium">
//                           {selectedCase.address || "Not specified"}
//                         </p>
//                       </div>
//                     </div>
...
//                   disabled={actionLoading}
//                 >
//                   {actionLoading ? "Processing..." : "Resolve Case"}
//                 </button>
//               </div>
//               {selectedCase.report_media.map((media) => {
//                 if (!media.file_url) {
  ...
  const getCaseTimeline = (caseItem) => {
    return [
      ...
      },
      {
        ...
        description: "Case is currently being investigated by our team.",
      },
    ];
  };
